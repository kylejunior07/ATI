...
from_currency_dropdown = ttk.Combobox(root, textvariable=from_currency, state="readonly", font=('Arial', 13))
...
to_currency_dropdown = ttk.Combobox(root, textvariable=to_currency, state="readonly", font=('Arial', 13))
